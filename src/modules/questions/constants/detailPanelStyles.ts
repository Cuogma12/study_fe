...
export const detailPanel = {
  shell: 'overflow-hidden rounded-xl border border-primary/20 bg-white shadow-xl dark:bg-slate-900',
  ...
  composeSection: 'border-b border-primary/15 bg-white px-5 py-5 dark:bg-slate-900 sm:px-6 sm:py-6',
  composeArea:
    'rounded-xl border border-gray-300 bg-slate-50/50 p-4 dark:border-slate-600 dark:bg-slate-800/40',
...
export const composeTextareaClass =
  'w-full resize-none rounded-xl border border-gray-300 bg-white p-3 text-sm text-slate-800 shadow-sm placeholder:text-slate-400 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/25 dark:border-slate-600 dark:bg-slate-900 dark:text-slate-100';
