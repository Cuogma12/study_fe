  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
      ...
      {repliesLoaded && replies.length > 0 && (
        <div className="mt-4 ml-4 space-y-3 border-l-2 border-slate-100 pl-4 dark:border-slate-800">
          {replies.map((reply) => (
            <div key={reply.id} className="rounded-lg bg-slate-50 p-3 dark:bg-slate-800/50">
